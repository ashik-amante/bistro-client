...
const Bistro = () => {
    return (
        <div className='bistro px-28 py-32 bg-fixed'>
            <div className=''>
                <div className='md:py-20 space-y-3 md:px-32 text-black bg-slate-100'>
                    <h1 className='text-center text-3xl  uppercase'>Bistro Boss</h1>
